...
package Tic_Tac_Toe is
    ...
    -- TODO: I don't know about using characters for column labels,
    --       maybe just use integers for both row and column labels?
    -- type Col_Label is new Character range 'A' .. 'C';
    ...
    -- type Available_Actions_Type is array (Action_Type) of Boolean; -- TODO: Is this needed?
